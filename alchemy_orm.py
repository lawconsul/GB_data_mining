...
class New(Base):
    ...
    preview_pic = Column(String)
    pdf = Column(String)

    # region = relationships('Region', backref='new')
    ...
    def __init__(self, **kwargs):
        ...
        self.preview_pic = kwargs.get('preview_pic')
...
class Region(Base):
    ...
    # id = Column(Integer, primary_key=True, unique=True, autoincrement=True)
    region = Column(String, primary_key=True, unique=True)
